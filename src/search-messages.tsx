...
function SearchMessagesCommand(props: LaunchProps<{ launchContext?: SearchMessagesLaunchContext }>) {
  ...
  return (
    <List
      isLoading={isLoading}
      navigationTitle={translations.commands.searchMessages.navigationTitle}
    ...
    >
      ...
      {!isLoading && messages.length === 0 && (
        <List.EmptyView
          ...
          title={error ? "Failed to Load Messages" : translations.commands.searchMessages.emptyTitle}
          description={
            error
              ? "Make sure Beeper Desktop is running and the API is enabled."
              : translations.commands.searchMessages.emptyDescription
          }
          actions={
            error ? (
              <ActionPanel>
  ...
  return (
    <ActionPanel>
      ...
      <ActionPanel.Section title="Copy">
        {message.text && <Action.CopyToClipboard title={translations.common.copyMessageText} content={message.text} />}
